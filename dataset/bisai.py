...
# water = [0,255,255]
    ...
    2: 'lincao',  # (0, 63, 191)
    3: 'building',  # (0, 127, 63)
    4: 'road',  # Ground Track Field   (0, 63, 255)
    5: 'gouzhuwu',  # (0, 100, 155)
    6: 'rengongwajuedi',  # (0, 0, 191)
    7: 'huangmo',  # (0, 127, 127)
    8: 'water',  # (0, 127, 255)
...
class bisaiSegmentation(data.Dataset):
        def __init__(self, root, train=True, transform=None):
            ...
            if train:
                ...
                split = 'test'
            annotation_folder = os.path.join(vaihingen_root, split, 'labels')
            image_folder = os.path.join(vaihingen_root, split, 'images')
...
class bisaiSegmentationIncremental(data.Dataset):
    def __init__(self,
                 root,
                 train=True,
                 transform=None,
        ...
        full_data = bisaiSegmentation(root, train)
        self.rank = rank
        self.labels = []
        self.labels_old = []
