...
task_vainhingen = {
    ...
    "4-2": # add Low vegetation and cars
        {
            0: [0, 1, 2, 3],
            1: [4, 5]
        },
    "3-3": # add Impervious, Low vegetation and cars
        {
            0: [0, 1, 2],
            1: [3, 4, 5]
        },
...
def get_task_list():
    return list(tasks_voc.keys()) + list(tasks_ade.keys()) + list(task_vainhingen.keys()) + list(task_ISAID.keys()) + list(task_bisai.keys())
...
def get_task_labels(dataset, name, step):
    if dataset == 'voc':
        ...
        task_dict = task_vainhingen[name]
    elif dataset == 'ISAID':
        task_dict = task_ISAID[name]
    elif dataset == 'bisai':
        task_dict = task_bisai[name]
    else:
